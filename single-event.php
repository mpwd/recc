...
?>
    ...
    <main class="mx-[5vw] my-20 max-w-6xl xl:mx-auto xl:my-32 flex flex-wrap-reverse gap-14">
        <div class="basis-0 flex-grow-lg min-w-[50%] [&_figure]:max-w-md [&_figure]:mx-auto [&_figure]:my-10">
            <?php the_content(); ?>
        </div>
        <div class="flex-grow basis-80">
            <div class="bg-opaqueSecondary p-8">
                ...
                if ($rsvpLink) {
                ?>
                    <a class="text-xl text-white bg-button py-4 px-10 block text-center" href="<?php echo $rsvpLink ?>">RSVP Now</a>
                <? } ?>
            </div>
        </div>
    </main>
